...
abuse_data_1 = df_shuffled[df_shuffled['cyberbullying_type'] == 'age'].head(500)

abuse_data_2 = df_shuffled[df_shuffled['cyberbullying_type'] == 'ethnicity'].head(500)

combined_abuse_data = pd.concat([abuse_data_1, abuse_data_2])
combined_abuse_data['cyberbullying_type'] = 1

non_abusive_rows = df_shuffled[df_shuffled['cyberbullying_type'] == 'not_cyberbullying'].head(1000)
